          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Sign up to get started with SwastikPharma</p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      minLength={8}
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 pr-12"
